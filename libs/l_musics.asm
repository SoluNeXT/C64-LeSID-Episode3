...
.namespace MUSICS{
	...
	//ici on les a laissé dans l'emplacement de compilation
		.label NbVoices 		=	VIC.SCREEN_RAM + 0 // MUSICS.MEMORY.NbVoices
		.label MusicStatus 		=	VIC.SCREEN_RAM + 0 // MUSICS.MEMORY.MusicStatus
		.label Disabled 		=	VIC.SCREEN_RAM + 0 // MUSICS.MEMORY.Disabled

		.label Speed 			=	VIC.SCREEN_RAM + 2 // MUSICS.MEMORY.Speed
		.label SpeedCountDown 	=	VIC.SCREEN_RAM + 4 // MUSICS.MEMORY.SpeedCountDown
		.label PatListPos 		=	VIC.SCREEN_RAM + 10 // MUSICS.MEMORY.PatListPos
		.label PatternPosV1 	=	VIC.SCREEN_RAM + 20 // MUSICS.MEMORY.PatternPosV1
		.label PatternPosV2 	=	VIC.SCREEN_RAM + 28 // MUSICS.MEMORY.PatternPosV2
		.label PatternPosV3 	=	VIC.SCREEN_RAM + 36 // MUSICS.MEMORY.PatternPosV3
		.label DurationV1 		=	VIC.SCREEN_RAM + 22 // MUSICS.MEMORY.DurationV1
		.label DurationV2 		=	VIC.SCREEN_RAM + 30 // MUSICS.MEMORY.DurationV2
		.label DurationV3 		=	VIC.SCREEN_RAM + 38 // MUSICS.MEMORY.DurationV3
	...
	//Les pointeurs doivent être positionnés en page zéro
		...
		.label	V1PatLstPointer	=	StartZP + 4
		.label	V2PatLstPointer	=	StartZP + 6
		.label	V3PatLstPointer	=	StartZP + 8
		.label	PatternPointer	=	StartZP + 10
		.label	Temp16bits		=	StartZP 	//MusicPointer n'est plus utilisé après le INIT
		.label	Temp16bits2		=	StartZP + 12
		.label	Temp8bits		=	StartZP + 14
		.label	Temp8bits2		=	StartZP + 15
